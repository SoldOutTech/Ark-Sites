...
export type ArkUIColour = {
  label: string
  value: ArkUIColourValue
}

type ArkUIColours = Record<string, ArkUIColour>

export const ArKUIColours = {
  TRANSPARENT: {
    label: 'Transparent',
    value: {
      color: 'transparent',
     className: 'transparent',
     textClassName: 'text-transparent'
    }
  },
  BLACK: {
    label: 'Black',
    value: {
      ...
      bgClassName: 'bg-backgroundBlack',
  ...
  PURPLE: {
    ...
    value: {
      color: '#D05DFF',
      className: 'purple-400',
      bgClassName: 'bg-purple-400',
  ...
  ROSE: {
    ...
    value: {
      color: '#FF5F5D',
      className: 'rose-400',
      bgClassName: 'bg-rose-400',
      textClassName: 'text-rose-400'
    }
  }

} as const satisfies ArkUIColours
...
export const bgColors = {
  TRANSPARENT: {
    label: tailwindColors.TRANSPARENT.label,
    value: {
      color: tailwindColors.TRANSPARENT.color500,
