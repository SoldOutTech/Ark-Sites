...
export const gradientBottomEndColourProps: types.ISideEditProp = {
  name: "bottomGradientEndColour",
  label: "Bottom Gradient End Colour",
  type: types.SideEditPropType.Select,
  selectOptions: {
    display: types.OptionsDisplay.Color,
    options: Object.values(ArKUIColours),
  },
};

export const gradientTopEndColourProps: types.ISideEditProp = {
