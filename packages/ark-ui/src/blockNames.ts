enum blockNames {
  ...
  // This is the equivalent of a 'footer-column', but for the ark-ui
  FooterColumnItem = 'footer-column-item',
  FooterColumnLink = 'footer-column-link',
  FooterSocialLink = 'footer-social-link',

  // Photo Grid Items
  PhotoGridItem = 'photo-grid-item',
  ProfileGridItem = 'profile-grid-item',
  IconLink = 'icon-link',
